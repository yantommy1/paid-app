    ...
    <div className="min-h-screen bg-paid-ink text-paid-mist">
      ...
      <main>
        ...
        <section className="border-b border-white/[0.08]">
          <div className="mx-auto grid max-w-6xl gap-14 px-6 py-20 lg:grid-cols-[minmax(0,1.08fr)_minmax(0,0.92fr)] lg:items-center lg:py-28">
            <SectionReveal>
              <div>
              ...
              <div className="grid gap-14 lg:grid-cols-2 lg:gap-20">
                ...
                <ul className="divide-y divide-white/[0.08] border-t border-white/[0.08]">
                  {[
                    ...
                    "One-click send from the Gmail sidebar",
                    "Contingency recovery for 60+ day invoices",
                  ].map((line) => (
                    <li
                      key={line}
        ...
        {/* Pricing + email */}
        <section id="email-signup" className="scroll-mt-24 border-b border-white/[0.08]">
          <div className="mx-auto max-w-6xl px-6 py-20 md:py-24">
            <SectionReveal>
              <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-white/40">
                Pricing
              ...
              <div className="mx-auto mt-20 max-w-lg border border-white/[0.1] bg-white/[0.02] p-8 md:p-10">
                <h3 className="font-display text-2xl text-paid-mist">
                  Start with your work email
                </h3>
                <p className="mt-2 text-sm leading-relaxed text-paid-mist/60">
                  We&apos;ll send a magic link to continue setup — same secure flow as
                  before.
                </p>
                <div className="mt-8">
                  <LandingEmailForm variant="dark" />
                </div>
              </div>
            </SectionReveal>
          </div>

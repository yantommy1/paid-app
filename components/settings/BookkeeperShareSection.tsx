...
export function BookkeeperShareSection() {
  ...
  async function invite() {
    ...
    try {
      ...
      if (!res.ok || !j.invite) {
        ...
        setMessage("Invite created. Copy the link below and share it with your bookkeeper.");
        setEmail("");
        await load();
      }
    } catch {
  ...
  return (
    <section className="border-t border-[#E5E5E5] py-10">
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-[1fr_200px_140px]">
        <input
          type="email"
        ...
        <select
          ...
          className="border border-[#E5E5E5] px-3 py-2 text-sm"
        >
          <option value="send">Review + approve drafts</option>
      ...
      <p className="mt-2 text-xs text-[#6B6B6B]">
        We&rsquo;ll generate a magic link and show it below — copy it and share via your usual email or chat.
      </p>
